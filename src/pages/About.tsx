...
export default function About() {
    ...
    return (
        <div className="text-white p-8 w-2/3 mx-32 justify-around mt-28">
            <h1 className="text-5xl mb-12 font-bold">🍏 About the Apple Hacks 🍎</h1>

            {/* Event Details Section */}
            <section data-aos="fade-up" className="mb-8">
                <h2 className="text-3xl mb-4 font-semibold">Event Details 📅</h2>
                <p className="text-xl">
            ...
            {/* Objectives Section */}
            <section data-aos="fade-up" className="mb-8">
                <h2 className="text-3xl mb-4 font-semibold">Objectives 🎯 </h2>
            ...
            {/* Schedule Section */}
            <section data-aos="fade-up" className="mb-8">
                <h2 className="text-3xl mb-4 font-semibold">Schedule ⏰</h2>
                <p className="text-xl">
            ...
            <section data-aos="fade-up" className="mb-8">
                <h2 className="text-3xl mb-4 font-semibold">Contact Information 📧</h2>
                <p className="text-xl">
